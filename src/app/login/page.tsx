    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-background">
            ...
            >
                ...
                <p className="text-foreground/50 mb-10">Dijital kartvizitini yönetmek için giriş yap.</p>
                ...
                <form onSubmit={handleEmailLogin} className="space-y-4 mb-8">
                    ...
                    >
                        {isLoading ? "Giriş Yapılıyor..." : "Email ile Devam Et"}
                    </button>
                    <p className="text-[10px] text-foreground/30 uppercase tracking-widest">Şifre gerektirmez</p>
                </form>
                ...
                <p className="mt-8 text-sm text-foreground/40 text-center">
                    Hesabın yok mu? <a href="/register" className="text-primary hover:underline">Hemen Kayıt Ol</a>
                </p>
            </motion.div>
        </div>
    )
