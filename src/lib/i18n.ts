export const translations: any = {
    tr: {
        ...
        occupationPlaceholder: "Örn: Yazılım Geliştirici, Avukat, Gayrimenkul Danışmanı",
        sloganLabel: "SLOGAN",
        sloganPlaceholder: "Senin için en iyi hizmet bizde...",
        bioLabel: "BİO / HAKKINDA",
        bioPlaceholder: "Kendinizi ve yaptığınız işleri kısaca anlatın...",
        phoneLabel: "TELEFON NUMARASI",
        targetAudienceLabel: "HEDEF KİTLE",
        targetAudiencePlaceholder: "Kime hitap ediyorsunuz? (Örn: Girişimciler, Kobiler)",
    ...
    en: {
        ...
        occupationPlaceholder: "e.g., Software Developer, Lawyer, Real Estate Agent",
        sloganLabel: "SLOGAN",
        sloganPlaceholder: "Best service for you...",
        bioLabel: "BIO / ABOUT",
        bioPlaceholder: "Briefly describe yourself and your work...",
        phoneLabel: "PHONE NUMBER",
        targetAudienceLabel: "TARGET AUDIENCE",
        targetAudiencePlaceholder: "Who are you targeting? (e.g., Entrepreneurs, SMBs)",
