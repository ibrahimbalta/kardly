            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                <div className="text-center lg:text-left">
                    ...
                    >
                        ...
                        <span>Dijital Kartvizitin Yeni Nesli</span>
                    </motion.div>
                    ...
                    <motion.h1
                        ...
                        className="text-6xl md:text-[90px] font-black tracking-tighter mb-8 leading-[0.9] text-slate-900 uppercase"
                    >
                        Networking <br />
                        <span className="gradient-text italic">Renklensin.</span>
                    </motion.h1>
                    ...
                    >
                        Klasik kartvizitleri bir kenara bırakın. Saniyeler içinde size özel, canlı ve profesyonel dijital kimliğinizi oluşturun.
                    </motion.p>
                    ...
                    >
                        <Link href="/register" className="group relative w-full sm:w-auto px-12 py-6 bg-rose-500 text-white font-black text-xs uppercase tracking-widest rounded-[2rem] transition-all hover:scale-105 active:scale-95 shadow-xl shadow-rose-200 flex items-center justify-center gap-4">
                            ÜCRETSİZ BAŞLA <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Link>
                        <button className="w-full sm:w-auto border border-slate-200 bg-white px-10 py-6 rounded-[2rem] font-black text-xs uppercase tracking-widest hover:bg-slate-50 transition-all flex items-center justify-center gap-3 text-slate-500 shadow-sm">
                            NASIL ÇALIŞIR?
                        </button>
                    </motion.div>
                ...
                >
                    ...
                    <div className="relative glass p-6 rounded-[4rem] border-white shadow-[0_20px_50px_rgba(244,63,94,0.1)] bg-white/60">
                        <div className="w-[340px] h-[640px] bg-slate-100 rounded-[3.5rem] overflow-hidden relative border-8 border-white shadow-2xl">
                            ...
                            <div className="p-8 flex flex-col items-center h-full bg-gradient-to-b from-white to-slate-50">
                                <div className="w-24 h-24 bg-gradient-to-tr from-rose-500 to-orange-500 rounded-[2rem] mb-12 shadow-2xl flex items-center justify-center">
                                ...
                                <div className="space-y-4 w-full">
                                    {[1, 2, 3].map(i => (
                                        <div key={i} className="h-14 w-full bg-white rounded-2xl shadow-sm border border-slate-100 flex items-center px-4 gap-4">
                                ...
                                <div className="mt-auto mb-6 w-full h-16 bg-rose-500 rounded-2xl shadow-xl shadow-rose-200 flex items-center justify-center text-xs font-black text-white tracking-widest uppercase">
                                    REHBERE EKLE
                                </div>
                            </div>
                        </div>
                        ...
                        <motion.div
                            ...
                            className="absolute top-12 -right-8 glass p-5 rounded-3xl border-white shadow-xl bg-white/95"
                        >
                            <QrCode className="w-8 h-8 text-rose-500 mb-2" />
                            <div className="text-[9px] font-black text-rose-500 uppercase tracking-widest">TARAT & KAYDET</div>
                        </motion.div>

                        <motion.div
                            animate={{ y: [0, 10, 0] }}
                            transition={{ duration: 5, repeat: Infinity }}
                            className="absolute bottom-20 -left-8 glass p-5 rounded-3xl border-white shadow-xl bg-white/95"
                        >
                            <ShieldCheck className="w-8 h-8 text-green-500 mb-2" />
                            <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest">GÜVENLİ VCARD</div>
                        </motion.div>
                    </div>
                </motion.div>
            </div>
